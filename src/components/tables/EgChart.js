...
const card = `col-md-6 ${classes.card}`;
...
const EgChart = () => {
  ...
  return (
    ...
    <div className={card}>
      ...
      <h3 className="text-center">Dashboard Report</h3>
      <div className="text-center mb-3">
      <label htmlFor="searchYear">Select Year: </label>
        <select id="searchYear" value={searchYear} onChange={handleSearchYearChange}>
